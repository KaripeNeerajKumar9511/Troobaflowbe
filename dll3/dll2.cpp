...
// Forward declaration to ensure `class_model` is known as a type where it's used
// in function prototypes in this translation unit. This prevents C2027 "use of
// undefined type 'class_model'" in situations where includes or ordering may
// not make the full definition visible yet.
class class_model;

 // using namespace String;


// If MFC is not available in this build define minimal stubs so message map macros
// and CWinApp references compile. This prevents syntax errors like C2059 at
// BEGIN_MESSAGE_MAP/END_MESSAGE_MAP when MFC headers are not included.
#ifndef BEGIN_MESSAGE_MAP
#define BEGIN_MESSAGE_MAP(a,b)
#define END_MESSAGE_MAP()
#define DECLARE_MESSAGEMap() // intentionally different name to avoid accidental use
...
// forward prototype so dll2.cpp can call warn_err defined in class_model.cpp
void warn_err(class_model* c1, char* buf1, int level,
	char* str_l, char* str_e, char* str_p,
	char* str_o, char* str_r, char* str_i);

// simple string macro used throughout the code
#ifndef sNULL
#define sNULL "\0"
#endif
	...
	//write_check(c1->varlocal, "after set oper ptrs ");
	 ...
	 //   add DOCK STOCK and scrap NAMES !!!  LOOP PARTS  START +1, +2
	  for(tpart  = c1->first_part_ptr(); tpart != NULL; tpart = c1->next_part_ptr()) { 
		  ...
		  // instead of "DOCK", use part-based naming
